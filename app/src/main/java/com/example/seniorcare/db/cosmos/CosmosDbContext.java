package com.example.seniorcare.db.cosmos;
...
public class CosmosDbContext<T extends IDbTableModelConvertible> {
...
//    private final String containerName = "Items";
    ...
    private CosmosClientService cosmosClientService;

    public CosmosDbContext(CosmosClientService cosmosClientService, T sample) {
...
//        scaleContainer();
    ...
    private void createDatabaseIfNotExists(){
        try {
            ...
            //  <CreateDatabaseIfNotExists>
            database = cosmosClientService.getClient().createDatabaseIfNotExists(databaseName).getDatabase();
            //  </CreateDatabaseIfNotExists>
    ...
    public void insertData(T newInstance) {
        //  <CreateItem>
